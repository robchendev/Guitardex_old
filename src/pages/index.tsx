  ...
  return (
    <Layout title="Home">
      <Container>
        ...
        <br/>
        <h2>Why I am developing this website</h2><br/>
        <Text>
        ...
        <h2>Fingerstyle Central Community</h2><br/>
        <Text>
        ...
        <Text>  
          <ul>
            <li>
              <a href="https://www.youtube.com/c/EddievanderMeer">Eddie van der Meer</a>
            </li>
            <li>
