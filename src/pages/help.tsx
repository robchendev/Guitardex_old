...
const Help = () => {
  return (
    <Layout title="Help">
      <h1>Help</h1>
      <h3>Add Techniques to Your Guitardex</h3>
      <CustomOL>
      ...
      <br />
      <h3>Delete/Reset Your Guitardex</h3>
      <CustomOL>
        <li>Go to your <Link to="/">Guitardex</Link></li>
